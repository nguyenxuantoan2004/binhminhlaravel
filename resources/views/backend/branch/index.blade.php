    ...
    <div id="content" class="container-fluid">
        <div class="card">
            <div class="card-header font-weight-bold d-flex justify-content-between align-items-center">
                <h5 class="">Danh sách chi nhánh</h5>
            ...
            <div class="card-body">
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <a href="{{ route('branch.edit', ['branch' => $branch->id]) }}"
                                                class="text-decoration-none text-secondary">{{ $branch->name }}</a>
                                        </td>
                                        {{-- Accessors --}}
                                        @if ($status != 'trash')
                                            <td><span class="{{ $branch->class }}">{{ $branch->status_label }}</span>
                                            </td>
                                        @endif
                                        ...
                                        <td>
                                            @if ($status == 'trash')
                                                <button class="btn btn-success btn-sm rounded-0 text-white btn-restore"
                                                    data-toggle="tooltip" title="Khôi phục" data-id="{{ $branch->id }}"
                                                    data-name="{{ $branch->name }}" data-name-module="{{ $nameModule }}"
                                                    data-name-module-vietnamese="{{ $nameModuleVietnamese }}">
                ...
                {{ $branchs->appends(['status' => request('status'), 'search' => request('search')])->onEachSide(1)->links() }}
