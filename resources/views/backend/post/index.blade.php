    ...
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <a href="{{ route('post.edit', ['post' => $post->id]) }}"
                                                class="text-decoration-none text-secondary">{{ $post->title }}</a>
                                        </td>
                                        <td><a href="{{ route('employee.edit', ['employee' => $post->employee_id]) }}" class="text-decoration-none text-secondary">{{ $post->employee->name }}</a></td>
                                        {{-- Accessors --}}
                                        @if ($status != 'trash')
                                            <td><span class="{{ $post->class }}">{{ $post->status_label }}</span>
                                            </td>
                                        @endif
                                        ...
                                        <td>
                                            @if ($status == 'trash')
                                                <button class="btn btn-success btn-sm rounded-0 text-white btn-restore"
                                                    data-toggle="tooltip" title="Khôi phục" data-id="{{ $post->id }}"
                ...
                {{ $posts->appends(['status' => request('status'), 'search' => request('search')])->onEachSide(1)->links() }}
