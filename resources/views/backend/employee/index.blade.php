        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="analytic">
                    ...
                    <a href="{{ route('employee.index', ['status' => 'permanently_locked', 'search' => request('search')]) }}"
                    ...
                    <a href="{{ route('employee.index', ['status' => 'trash', 'search' => request('search')]) }}"
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <a href="{{ route('employee.edit', ['employee' => $employee->id]) }}"
                                                class="text-decoration-none text-secondary">{{ $employee->name }}</a>
                                        </td>
                                        <td>
                                        ...
                                        {{-- Accessors --}}
                                        @if ($status != 'trash')
                                            <td><span class="{{ $employee->class }}">{{ $employee->status_label }}</span>
                                            </td>
                                        @endif
                                        ...
                                        <td>
                                            @if ($status == 'trash')
                                                <button class="btn btn-success btn-sm rounded-0 text-white btn-restore"
                                                    data-toggle="tooltip" title="Khôi phục" data-id="{{ $employee->id }}"
                ...
                {{ $employees->appends(['status' => request('status'), 'search' => request('search')])->onEachSide(1)->links() }}
