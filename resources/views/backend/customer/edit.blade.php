                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option value="active" 
                                    {{ old('status', $customer->status ?? "") == 'active' ? 'selected' : '' }}>Hoạt động
                                    </option>
                                    <option value="temporary_lock"
                                        {{ old('status', $customer->status ?? "") == 'temporary_lock' ? 'selected' : '' }}>Khóa tạm thời</option>
                                    <option value="permanently_locked"
                                        {{ old('status', $customer->status ?? "") == 'permanently_locked' ? 'selected' : '' }}>Khóa vĩnh viễn
                                    </option>
                                </select>
                                @error('status')
                                    <div class="text-danger">{!! $message !!}</div>
