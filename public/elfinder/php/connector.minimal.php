...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'id' => '1',
			'driver' => 'Trash',
			'path' => '../files/.trash/', //tương đối
			// 'path' => 'D:/laragon/www/ChoThueXe/public/elfinder/files/.trash', // tuyệt đối
			'tmbURL' => dirname($_SERVER['PHP_SELF']) . '/../files/.trash/.tmb/',
			'winHashFix' => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
			'uploadDeny' => array('all'),                // Recomend the same settings as the original volume that uses the trash
			'uploadAllow' => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain', 'video/mp4'), // Same as above
